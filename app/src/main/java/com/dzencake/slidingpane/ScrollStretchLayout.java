 ...
 */
public class ScrollStretchLayout extends RecyclerView.LayoutManager {
		...
		LinearSmoothScroller linearSmoothScroller =
				new LinearSmoothScroller(recyclerView.getContext()) {
					...
					public PointF computeScrollVectorForPosition(int targetPosition) {
						return ScrollStretchLayout.this
	...
	private void layoutForPredictiveAnimations(RecyclerView.Recycler recycler,
		...
		if (scrapExtraStart > 0) {
			...
			mLayoutState.mCurrentPosition += -1; // TODO: mLayoutState.mCurrentPosition--
			fill(recycler, mLayoutState, state, false);
		}
	...
	void ensureLayoutState() {
		...
		if (mOrientationHelper == null) {
			mOrientationHelper = OrientationHelper.createOrientationHelper(this, LinearLayout.VERTICAL);
		}
	}
	...
	private int computeScrollOffset(RecyclerView.State state) {
		...
		return ScrollbarHelper.computeScrollOffset(state, mOrientationHelper,
				...
				mSmoothScrollbarEnabled, false);  // TODO: Modify constructor
	}
	...
	int fill(RecyclerView.Recycler recycler, LayoutState layoutState,
		...
		while (remainingSpace > 0) {
			...
			consumed = getChildClosestToStart().getHeight();
		}
